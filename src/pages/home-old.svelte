      ...
      <MessagebarSheet>
        ...
        <MessagebarSheetItem>
            <!-- <List>
                ...
                <ListItem checkbox value="foo" title="Foo Title" link="/swiper/">Swiper</ListItem>
                <ListItem checkbox value="Bar" title="Bar Title"></ListItem>
                <ListItem checkbox value="too" title="too Title"></ListItem>
              
              </List> -->
              <List>
                <ListItem title="Super Hero" smartSelect smartSelectParams={{openIn: 'popover'}}>
                    <select name="superhero" multiple value={['Batman']}>
                      <option value="bm">Batman</option>
                      <option value="sm">Superman</option>
                      <option value="Hulk">Hulk</option>
                      <option value="spiderm">Spiderman</option>
                      <option value="Iman">Ironman</option>
